...
\begin{itemize}
	...
	Find(x)\\
    	\hspace*{1em}if x.parent != x\\
     		\hspace*{1em}\hspace*{1em}x.parent := Find(x.parent)\\
   	return x.parent
   	
   	\item Path Halving \\
   	Find(x)\\
   		\hspace*{1em}while x.parent != x\\
     		\hspace*{1em}\hspace*{1em}x.parent := x.parent.parent\\
     		\hspace*{1em}\hspace*{1em}x := x.parent\\
   return x
